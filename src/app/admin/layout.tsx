...
export default async function AdminLayout({
  ...
  try {
      ...
      <div className="flex min-h-screen bg-brand-dark">
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          <main className="flex-1">
            ...
            <div className="py-6 px-4 sm:px-6 lg:py-8 lg:px-8 max-w-7xl mx-auto animate-fade-in">
              {children}
            </div>
          </main>
        </div>
    ...
    return (
      <div className="p-10 bg-red-900/80 text-white rounded-xl m-10 z-50 relative backdrop-blur-sm border border-red-500/20">
        ...
        {isDev ? (
          ...
          <p className="text-sm">An unexpected error occurred. Please try again or contact support.</p>
        )}
      </div>
    )
  }
