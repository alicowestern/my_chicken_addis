        ...
        {onSearchChange && (
          <div className="relative w-full sm:w-72">
            <input
              ...
              className="w-full px-4 py-2 bg-brand-surface border border-[rgba(255,255,255,0.1)] rounded-lg text-sm text-brand-white placeholder:text-brand-gray focus:outline-none focus:ring-2 focus:ring-brand-cyan/30 focus:border-brand-cyan transition-all"
            />
          </div>
        )}
